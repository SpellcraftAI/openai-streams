...
export declare const OpenAIApiAxiosParamCreator: (configuration?: Configuration) => {
  /**
     ...
     * @param {string} fineTuneId The ID of the fine-tune job to cancel @param
     * {*} [options] Override http request option. @throws {RequiredError}
     */
  cancelFineTune: (fineTuneId: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
  /**
     *
     * @summary Answers the specified question using the provided documents and
     * examples.  The endpoint first [searches](/docs/api-reference/searches)
     * over provided documents or files to find relevant context. The relevant
     * context is combined with the provided examples and question to create the
     * prompt for [completion](/docs/api-reference/completions).
     * @param {CreateAnswerRequest} createAnswerRequest @param {*} [options]
     * Override http request option. @deprecated @throws {RequiredError}
     */
  createAnswer: (createAnswerRequest: CreateAnswerRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
  /**
     *
     * @summary Classifies the specified `query` using provided examples.  The
     * endpoint first [searches](/docs/api-reference/searches) over the labeled
     * examples to select the ones most relevant for the particular query. Then,
     * the relevant examples are combined with the query to construct a prompt
     * to produce the final label via the
     * [completions](/docs/api-reference/completions) endpoint.  Labeled
     * examples can be provided via an uploaded `file`, or explicitly listed in
     * the request using the `examples` parameter for quick tests and small
     * scale use cases.
     * @param {CreateClassificationRequest} createClassificationRequest @param
     * {*} [options] Override http request option. @deprecated @throws
     * {RequiredError}
     */
  ...
  /**
     ...
     * @param {CreateCompletionRequest} createCompletionRequest @param {*}
     * [options] Override http request option. @throws {RequiredError}
     */
  createCompletion: (createCompletionRequest: CreateCompletionRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
  /**
     *
     * @summary Creates a new edit for the provided input, instruction, and
     * parameters
     * @param {CreateEditRequest} createEditRequest @param {*} [options]
     * Override http request option. @throws {RequiredError}
     */
  createEdit: (createEditRequest: CreateEditRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
  /**
     *
     * @summary Creates an embedding vector representing the input text.
     * @param {CreateEmbeddingRequest} createEmbeddingRequest @param {*}
     * [options] Override http request option. @throws {RequiredError}
     */
  createEmbedding: (createEmbeddingRequest: CreateEmbeddingRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
  /**
     *
     * @summary Upload a file that contains document(s) to be used across
     * various endpoints/features. Currently, the size of all the files uploaded
     * by one organization can be up to 1 GB. Please contact us if you need to
     * increase the storage limit.
     * @param {File} file Name of the [JSON
     * Lines](https://jsonlines.readthedocs.io/en/latest/) file to be uploaded.
     * If the &#x60;purpose&#x60; is set to \\\&quot;fine-tune\\\&quot;, each
     * line is a JSON record with \\\&quot;prompt\\\&quot; and
     * \\\&quot;completion\\\&quot; fields representing your [training
     * examples](/docs/guides/fine-tuning/prepare-training-data). @param
     * {string} purpose The intended purpose of the uploaded documents.  Use
     * \\\&quot;fine-tune\\\&quot; for
     * [Fine-tuning](/docs/api-reference/fine-tunes). This allows us to validate
     * the format of the uploaded file. @param {*} [options] Override http
     * request option. @throws {RequiredError}
     */
  createFile: (file: File, purpose: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
  /**
     *
     * @summary Creates a job that fine-tunes a specified model from a given
     * dataset.  Response includes details of the enqueued job including job
     * status and the name of the fine-tuned models once complete.  [Learn more
     * about Fine-tuning](/docs/guides/fine-tuning)
     * @param {CreateFineTuneRequest} createFineTuneRequest @param {*} [options]
     * Override http request option. @throws {RequiredError}
     */
  ...
  /**
     ...
     * @param {CreateImageRequest} createImageRequest @param {*} [options]
     * Override http request option. @throws {RequiredError}
     */
  createImage: (createImageRequest: CreateImageRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
  /**
     *
     * @summary Creates an edited or extended image given an original image and
     * a prompt.
     * @param {File} image The image to edit. Must be a valid PNG file, less
     * than 4MB, and square. @param {File} mask An additional image whose fully
     * transparent areas (e.g. where alpha is zero) indicate where
     * &#x60;image&#x60; should be edited. Must be a valid PNG file, less than
     * 4MB, and have the same dimensions as &#x60;image&#x60;. @param {string}
     * prompt A text description of the desired image(s). The maximum length is
     * 1000 characters. @param {number} [n] The number of images to generate.
     * Must be between 1 and 10. @param {string} [size] The size of the
     * generated images. Must be one of &#x60;256x256&#x60;,
     * &#x60;512x512&#x60;, or &#x60;1024x1024&#x60;. @param {string}
     * [responseFormat] The format in which the generated images are returned.
     * Must be one of &#x60;url&#x60; or &#x60;b64_json&#x60;. @param {string}
     * [user] A unique identifier representing your end-user, which will help
     * OpenAI to monitor and detect abuse. [Learn
     * more](/docs/usage-policies/end-user-ids). @param {*} [options] Override
     * http request option. @throws {RequiredError}
     */
  ...
  /**
     ...
     * @param {File} image The image to use as the basis for the variation(s).
     * Must be a valid PNG file, less than 4MB, and square. @param {number} [n]
     * The number of images to generate. Must be between 1 and 10. @param
     * {string} [size] The size of the generated images. Must be one of
     * &#x60;256x256&#x60;, &#x60;512x512&#x60;, or &#x60;1024x1024&#x60;.
     * @param {string} [responseFormat] The format in which the generated images
     * are returned. Must be one of &#x60;url&#x60; or &#x60;b64_json&#x60;.
     * @param {string} [user] A unique identifier representing your end-user,
     * which will help OpenAI to monitor and detect abuse. [Learn
     * more](/docs/usage-policies/end-user-ids). @param {*} [options] Override
     * http request option. @throws {RequiredError}
     */
  ...
  /**
     ...
     * @param {CreateModerationRequest} createModerationRequest @param {*}
     * [options] Override http request option. @throws {RequiredError}
     */
  createModeration: (createModerationRequest: CreateModerationRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
  /**
     *
     * @summary The search endpoint computes similarity scores between provided
     * query and documents. Documents can be passed directly to the API if there
     * are no more than 200 of them.  To go beyond the 200 document limit,
     * documents can be processed offline and then used for efficient retrieval
     * at query time. When `file` is set, the search endpoint searches over all
     * the documents in the given file and returns up to the `max_rerank` number
     * of documents. These documents will be returned along with their search
     * scores.  The similarity score is a positive score that usually ranges
     * from 0 to 300 (but can sometimes go higher), where a score above 200
     * usually means the document is semantically similar to the query.
     * @param {string} engineId The ID of the engine to use for this request.
     * You can select one of &#x60;ada&#x60;, &#x60;babbage&#x60;,
     * &#x60;curie&#x60;, or &#x60;davinci&#x60;. @param {CreateSearchRequest}
     * createSearchRequest @param {*} [options] Override http request option.
  ...
  /**
     ...
     * @param {string} fileId The ID of the file to use for this request @param
     * {*} [options] Override http request option. @throws {RequiredError}
     */
  ...
  /**
     ...
     * organization.
     * @param {string} model The model to delete @param {*} [options] Override
     * http request option. @throws {RequiredError}
     */
  ...
  /**
     *
     * @summary Lists the currently available (non-finetuned) models, and
     * provides basic information about each one such as the owner and
     * availability.
     * @param {*} [options] Override http request option. @deprecated @throws
     * {RequiredError}
     */
  ...
  /**
     ...
     * @param {*} [options] Override http request option. @throws
     * {RequiredError}
     */
  ...
  /**
     ...
     * @param {boolean} [stream] Whether to stream events for the fine-tune job.
     * If set to true, events will be sent as data-only [server-sent
     * events](https://developer.mozilla.org/en-US/docs/Web/API/Server-sent_events/Using_server-sent_events#Event_stream_format)
     * as they become available. The stream will terminate with a &#x60;data:
     * [DONE]&#x60; message when the job is finished (succeeded, cancelled, or
     * failed).  If set to false, only events generated so far will be returned.
     * @param {*} [options] Override http request option. @throws
     * {RequiredError}
     */
  ...
  /**
     *
     * @summary Lists the currently available models, and provides basic
  ...
  /**
     *
     * @summary Retrieves a model instance, providing basic information about it
  ...
  /**
     *
     * @summary Gets info about the fine-tune job.  [Learn more about
     * Fine-tuning](/docs/guides/fine-tuning)
     * @param {string} fineTuneId The ID of the fine-tune job @param {*}
     * [options] Override http request option. @throws {RequiredError}
     */
  retrieveFineTune: (fineTuneId: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
  /**
     *
     * @summary Retrieves a model instance, providing basic information about
     * the model such as the owner and permissioning.
     * @param {string} model The ID of the model to use for this request @param
     * {*} [options] Override http request option. @throws {RequiredError}
     */
...
export declare class OpenAIApi extends BaseAPI {
  ...
  /**
     ...
     * @param {CreateClassificationRequest} createClassificationRequest @param
     * {*} [options] Override http request option. @deprecated @throws
     * {RequiredError} @memberof OpenAIApi
     */
  ...
  /**
     ...
     * @summary Creates a completion for the provided prompt and parameters
     * @param {CreateCompletionRequest} createCompletionRequest @param {*}
     * [options] Override http request option. @throws {RequiredError} @memberof
     * OpenAIApi
     */
  ...
  /**
     ...
     * parameters
     * @param {CreateEditRequest} createEditRequest @param {*} [options]
     * Override http request option. @throws {RequiredError} @memberof OpenAIApi
     */
  ...
  /**
     ...
     * [Fine-tuning](/docs/api-reference/fine-tunes). This allows us to validate
     * the format of the uploaded file. @param {*} [options] Override http
     * request option. @throws {RequiredError} @memberof OpenAIApi
     */
  ...
  /**
     ...
     * OpenAI to monitor and detect abuse. [Learn
     * more](/docs/usage-policies/end-user-ids). @param {*} [options] Override
     * http request option. @throws {RequiredError} @memberof OpenAIApi
     */
  ...
  /**
     ...
     * &#x60;curie&#x60;, or &#x60;davinci&#x60;. @param {CreateSearchRequest}
     * createSearchRequest @param {*} [options] Override http request option.
     * @deprecated @throws {RequiredError} @memberof OpenAIApi
     */
